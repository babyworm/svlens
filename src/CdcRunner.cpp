...
void cdccli::printCdcUsage() {
    const std::string usage =
        ...
        "  --auto-clocks           No-op flag (auto-detection is always on); kept\n"
        ...
        "  svlens cdc --top soc_top rtl/*.sv --sdc syn/clocks.sdc\n"
        "  svlens cdc --top soc_top rtl/*.sv --clock-yaml clock_domains.yaml --strict -q\n\n"
        "Exit Codes:\n"
